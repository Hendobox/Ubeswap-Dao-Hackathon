...
such other services as may be reasonably be requested by the DAO (collectively, the “Services”).`,
  ...
  `Notice. All notices shall be in writing and delivered electronically:`,
];

export const ContributorAgreementForm: React.FC<AgreementProps> = ({
  date,
  dao,
  email,
  walletAddress,
  ...
  const title = "UBE DAO Agreement Forn";
  return (
    <Document>
      <Page size="A4">
        <View>
          <Text>DAO CONTRIBUTOR AGREEMENT</Text>
        </View>

        <View>
          <Text>
            This DAO Contributor Agreement (the “Agreement”) is entered into
            between the organization known as Ubeswap DAO (the “DAO”) and the
            contributor named on the signature page hereto (the “Contributor”)
            as of {date.toDateString()} (“Effective Date”). The DAO and the
        ...
        <View>
          If to the DAO: ${dao.email}
          If to the Contributor: ${email}
          The parties agree that all communication made from each of the above
          email addresses can be relied upon by the recipient party as the
          conclusive, binding communication by the party sending such
          communication using such email address. Miscellaneous. This Agreement
          and the Services performed hereunder are personal to the Contributor
          and the Contributor shall not have the right or ability to assign,
          transfer or subcontract any obligations under this Agreement without
          the written consent of the DAO. Any attempt to do so shall make the
          Agreement void. The DAO shall be free to transfer any of its rights
          under this Agreement to a third party. Any breach of Sections 3 or 4
          will cause irreparable harm to the DAO for which damages would not be
          an adequate remedy, and therefore, the DAO shall be entitled to
          injunctive relief with respect thereto in addition to any other
          remedies. This is the entire agreement between the parties with
          respect to the subject matter hereof and no changes or modifications
          or waivers to this Agreement shall be effective unless in writing and
          signed by both parties. This Agreement may be executed in two or more
          ...
          other applicable law) or other transmission method and any counterpart
          so delivered shall be deemed to have been duly and validly delivered
          and be valid and effective for all purposes. In the event that any
          ...
          in full force and effect and enforceable. This Agreement shall be
          governed by and construed in accordance with the laws of the State of
          Delaware without regard to the conflicts of law provisions thereof. In
          ...
          fees. [Remainder of page intentionally left blank] The undersigned
          have executed this DAO Contributor Agreement as of the Effective Date.
        </View>

        <View>
          <Text>DAO:</Text>
          <Text>** Name:** Ubeswap DAO</Text>
          <Text>Wallet address: {dao.milestoneContract}</Text>
          <Text>Email: {dao.email}</Text>
          <Text>Discord Username: {dao.discord}</Text>
          <Text>CONTRIBUTOR: By: {beneficiaryName}</Text>
          <Text>Name: {projectName}</Text>
          <Text>Title: Agreement Form for {projectName}</Text>
        ...
        <View>
          APPENDIX A A person or entity whose name appears on (i) the List of
          Specially Designated Nationals and Blocked Persons maintained by the
          U.S. Office of Foreign Assets Control; (ii) other lists of prohibited
          persons and entities as may be mandated by applicable law or
          regulation; or (iii) such other lists of prohibited persons and
          entities as may be provided to the Fund in connection therewith; A
          Senior Foreign Political Figure (a), any member of a Senior Foreign
          Political Figure&apos;s “immediate family,” which includes the
          figure’s parents, siblings, spouse, children and in-laws, or any Close
          Associate of a Senior Foreign Political Figure (b), or a person or
          entity resident in, or organized or chartered under, the laws of a
          Non-Cooperative Jurisdiction (c); A person or entity resident in, or
          organized or chartered under, the laws of a jurisdiction that has been
          designated by the U.S. Secretary of the Treasury under Section 311 or
          312 of the USA PATRIOT Act as warranting special measures due to money
          laundering concerns; or A person or entity who gives the Contributor
          reason to believe that its funds originate from, or will be or have
          been routed through, an account maintained at a Foreign Shell Bank
          (d), an “offshore bank,” or a bank organized or chartered under the
          laws of a Non-Cooperative Jurisdiction. (a) &ldquo;Senior Political
          Figure&rdquo; means a senior official in the executive, legislative,
          administrative, military or judicial branches of a foreign government
          (whether elected or not), a senior official of a major foreign
          ...
          any corporation, business or other entity that has been formed by, or
          for the benefit of, a Senior Foreign Political Figure. (b)
          &ldquo;Close Associate of a Senior Foreign Political Figure&rdquo;
          means a person who is widely and publicly known internationally to
          maintain an unusually close relationship with the Senior Foreign
          ...
          on behalf of the Senior Foreign Political Figure. (c) “Non-Cooperative
          Jurisdiction” means any foreign country that has been designated as
          ...
          Financial Task Force on Money Laundering, of which the U.S. is a
          member and with which designation the U.S. representative to the group
          or organization continues to concur. (d) “Foreign Shell Bank” means a
          Foreign Bank without a Physical Presence in any country, but does not
          include a Regulated Affiliate. A “Foreign Bank” means an organization
          that (i) is organized under the laws of a foreign country, (ii)
          engages in the business of banking, (iii) is recognized as a bank by
          the bank supervisory or monetary authority of the country of its
          organization or principal banking operations, (iv) receives deposits
          to a substantial extent in the regular course of its business, and (v)
          has the power to accept demand deposits, but does not include the U.S.
          branches or agencies of a foreign bank. “Physical Presence” means a
          place of business that is maintained by a Foreign Bank and is located
          at a fixed address, other than solely a post office box or an
          ...
          and (iii) is subject to inspection by the banking authority that
          licensed the Foreign Bank to conduct banking activities. “Regulated
          Affiliate” means a Foreign Shell Bank that is an affiliate of a
          depository institution, credit union or Foreign Bank that maintains a
          Physical Presence in the U.S. or a foreign country regulating such
